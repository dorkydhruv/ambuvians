...
class _DashboardState extends State<Dashboard> {
  ...
  Widget build(BuildContext context) {
        ...
        body: Container(
          ...
          child: Column(
            children: [
              ...
              Row(
                children: [
                  _buildstatusContainer(context: context, color: const Color.fromARGB(255, 233, 211, 211), wid:   Column(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              ...
                              child: Container(width: 80,height: 20,decoration: BoxDecoration(color: Colors.redAccent,borderRadius: BorderRadius.circular(20)),child: const Center(
                                child: Text(
                                            "Profile",
                  ...
                  _buildstatusContainer(context: context, color: const Color.fromRGBO(239, 70, 55,1), wid: Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          const Text(
    'Health Status',
    ...
    Image.asset('src/healthy_kid.png',height: 100,width: 100,),
    Container(width: 80,height: 20,decoration: BoxDecoration(color: Colors.green,borderRadius: BorderRadius.circular(20)),child: const Center(
      child: Text(
                "Healthy",
                textAlign: TextAlign.center,
                style: TextStyle(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => Map_page(),)),
                    child: booking(str: 'Normal Booking', color: Colors.green)),
                ],
              )
            ],
          )
  ...
  Widget _buildstatusContainer({required BuildContext context, required Color color, required Widget wid}){
    return Container(
        ...
        child: Row(
          children: [
            ...
            style: TextStyle(
              ...
              booking(str: "Vedio call", color: Colors.greenAccent,width: 100)
            ],)
              ],
            )
          ],
  ...
  Widget booking({required String str, required Color color, double? width=120}) {
    return Container(
